...
{
    /// <summary>
    /// Class with the same implementation of ModuleInitializer class with a difference to handle User Roles.
    /// </summary>
    public class RolesBasedModuleInitializer : IModuleInitializer
    {
        ...
        public RolesBasedModuleInitializer(IServiceLocator serviceLocator, ILoggerFacade loggerFacade)
        {
        ...
        protected virtual IModule CreateModule(string typeName)
        {
            ...
            if (moduleType == null)
            {
                throw new ModuleInitializeException(string.Format(CultureInfo.CurrentCulture, typeName));
            }
